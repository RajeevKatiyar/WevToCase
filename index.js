...
const tokenUrl = "https://zedonk--zedonkdev.sandbox.my.salesforce.com/services/oauth2/token";
const clientId = "3MVG9kfeuo6xCm.qoV.HA53lfC9QhRr5cKmiCjODjswL5DoydxiCyUA4Pdt625kYbnOEwHFWT4MWwM8YxEBwU";
const clientSecret = "32B0FFE870DC26B6C41A34C4E946F4180643A5158B78E48ABD39E11ABC93C039";
...
function uploadFileToSalesforce(file, accessToken) {
    ...
    fileReader.onload = function (event) {
        ...
        const uploadUrl = 'https://zedonk--zedonkdev.sandbox.lightning.force.com/services/data/v54.0/sobjects/ContentVersion/';
        const requestData = {
            Title: file.name,
            PathOnClient: file.name,
            VersionData: fileData
        ...
        fetch(uploadUrl, {
            ...
            .then(data => {
                console.log("File uploaded successfully:", data);
                 const contentDocumentId = data.id; 
                console.log('contentDocumentId--------------------------',contentDocumentId);
                document.getElementById('00NUA000001N4dX').value = contentDocumentId;
